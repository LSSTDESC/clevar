# ClEvaR documentation build configuration file, created by
import os
import subprocess
import sys
...
MOCK_MODULES = ["numpy", "astropy", "astropy.cosmology", "astropy.coordinates", "scipy", "scipy.interpolate", "pyccl", "healpy", "healsparse"]
